...
export const requiredStr = (value, message = 'requiredField') => !!(value.trim()) || translate(`$vuetify.${message}`)
...
export const smallerThan = (value, max = 1001) => value < max || translate('$vuetify.maxLengthError', minLength)
